module ApplicationHelper
  ...
  def label_class(options={})
    "text-gray-400 block mb-1 font-normal leading-normal #{options[:extended_classes]}"
  end
  ...
  def link_class(options={})
    "text-gray-500 underline hover:no-underline hover:text-gray-800 block #{options[:extended_classes]}"
  end
